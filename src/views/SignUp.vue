  ...
  data() {
    return {
      ...
      rules: {
        ...
        passMatch: (v) => v === this.pass || "The password you entered don't match",
  ...
  methods: {
    ...
    signUp() {
      const data = {
        ...
        birth_date: this.bday,
        gender: this.gender,
        home_address: `${this.selectedProvince}, ${this.selectedMunicipalities} , ${this.address}`,
